...
/// <summary>
/// Copied from SemanticKernel repo. At this moment, SemanticKernel nuget package has not been updated to include Text namespace 
/// </summary>
...
public static class TextChunker
{
    ...
    public static List<string> SplitPlainTextLines(string text, int maxTokensPerLine)
    {
        ...
        InternalSplitLines(text.Replace("\r\n", "\n"), maxTokensPerLine, trim: true, s_plaintextSplitOptions, result);
        return result;
    }
